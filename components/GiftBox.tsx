...
const GiftBox: React.FC<GiftBoxProps> = ({ onOpen }) => {
  ...
  return (
    <div className="flex flex-col items-center justify-center space-y-10 z-20 relative">
      ...
      <div className={`transition-all duration-500 ${isPressing ? 'opacity-50 scale-95' : 'opacity-100 scale-100'} text-center space-y-1`}>
        <h2 className="text-xl font-extrabold tracking-tight text-slate-700">A Gift For You</h2>
      ...
      >
        {/* Progress Ring Background (Halo) - Gold/Warm */}
        <div 
        ...
        {/* CSS Gift Box (Classic Red & Green) */}
        <div 
        ...
        >
          ...
          <div className="absolute bottom-0 w-full h-5/6 bg-red-700 rounded-3xl shadow-[0_20px_40px_-10px_rgba(185,28,28,0.4)] overflow-hidden">
             ...
             {/* Vertical Ribbon - Gold/White mix or just White */}
      ...
      {/* Minimal Progress Bar - Green fill */}
